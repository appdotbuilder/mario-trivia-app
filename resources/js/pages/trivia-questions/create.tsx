...
export default function TriviaQuestionCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('trivia-questions.store'));
    };
    ...
    return (
        <>
            <Head title="🧠 Create New Trivia Question - Admin" />
                    ...
                    <div className="rounded-3xl bg-white p-12 shadow-2xl">
                        <div className="mb-8 text-center">
                            ...
                            <p className="text-lg text-gray-600">
                                Add a challenging Super Mario question to the game!
                            </p>
                        </div>
